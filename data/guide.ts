...
export const guideCards: GuideCard[] = [
  ...
  },
  {
    ...
    section: "campus",
    title: "新生报到，按顺序办完就好",
    summary: "先在迎新网确认报到信息；到校按现场指引完成报到和住宿；校园卡、网络和邮箱再按需要开通。",
    steps: [
      "出发前打开迎新网和学院通知，确认报到日期、校区、接待点、进校时间、住宿安排与学院联系人。",
      "到校后按现场指引完成报到、入住和身份核验；有冲突或变更时，以迎新现场和学院通知为准。",
      "安顿好后再看迎新系统待办：校园卡、校园网、邮箱和“一网通办”逐项开通；当天只先解决上课、联网和生活所需。",
    ],
    time: "出发前一天和落地后各核验一次；其余事项以迎新系统和学院通知的办理时间为准",
    tip: "只认自己的迎新系统、学院通知和现场安排；不要用其他学院、往届信息替代自己的时间表。",
    backup: "官网加载慢、通知冲突或不知道下一步时，直接联系学院辅导员或迎新现场；记下两份通知的发布时间，方便对方确认。",
    verifiedAt: guideVerifiedAt,
    freshness: "开学季核验",
    actionLabel: "进入同济迎新网",
    actionUrl: "https://hello.tongji.edu.cn/",
    ...
    keywords: ["报到", "日期", "校区", "接待点", "联系人", "提前入住", "迎新系统", "录取通知书", "图书馆", "教务", "迎新", "校医院", "办事", "新生清单", "身份激活", "人脸", "校园卡", "一卡通", "校园网", "邮箱", "一网通办", "密码"],
  },
];

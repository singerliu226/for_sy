...
const guideViews = [
  { id: "arrival", index: "01", title: "落地通勤", description: "看清楚自己在哪里，用最安全方便的方法到学校", sections: ["arrival"] },
  ...
  return (
    <main className="molwan-site guide-site">
      <header className="molwan-nav guide-nav">
        ...
        <nav aria-label="主导航"><a href="/assistant">小魔丸</a><a className="is-current" href="/guide">魔都攻略</a><a href="/messages">最近的事儿</a><a href="/anniversaries">纪念日</a></nav>
      </header>

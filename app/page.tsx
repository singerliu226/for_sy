  ...
  return (
    <main className="molwan-site molwan-home">
      <header className="molwan-nav">
        <Link href="/" className="molwan-brand" aria-label="魔丸小助手首页">
      ...
      <section className="molwan-home__doors" aria-label="选择一个入口">
        <Link className="molwan-door molwan-door--guide" href="/guide">
        ...
        <Link className="molwan-door molwan-door--anniversary" href="/anniversaries">
      ...
      <footer className="molwan-footer">
        <span>不急，魔丸在这里。</span>
        <Link href="/guide">先去看看今天的地图 →</Link>
      </footer>
    </main>
  );
}

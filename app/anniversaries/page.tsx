  ...
  return (
    <main className="molwan-site anniversary-site">
      <header className="molwan-nav">
        ...
        <nav aria-label="主导航"><a href="/assistant">小助手</a>{siteFeatures.guide && <a href="/guide">魔都攻略</a>}<a href="/messages">小留言</a><a className="is-current" href="/anniversaries">纪念日</a></nav>
      </header>

        ...
        {open && <>
          {!reduced && !videoFailed && <div className={`welcome-video${videoPlaying ? " is-playing" : ""}`} aria-hidden="true">
            ...
            <div className="welcome-video__frame">
              <video ref={video} src="/welcome/midautumn-homecoming.mp4" autoPlay muted playsInline preload="auto" onCanPlay={tryVideo} onPlaying={() => setVideoPlaying(true)} onEnded={dismiss} onError={() => setVideoFailed(true)} />
              <span>思怡，欢迎回家！</span>
            </div>
          </div>}
